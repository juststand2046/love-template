<template>
  <div id="birthday">
    <div class="birthday">
      <div class="cs">
        <img :src="require('@/assets/img/4.png')" id="logo" />
      </div>
      <canvas class="canvas" width="1820" height="905"></canvas>
      <p class="text" style="color: #ed3073">
        happy birthday
        <br />
        <span id="span_dt_dt">2022 04 26</span>
      </p>
    </div>
    <div class="bottom-info">
      tips:从刚才到现在，你所看到的每一个字，每一句话都发自我的内心，都是我最真实的情感表达。但是，
      这些都不应该成为影响你决定的因素，同样的，我希望你能遵从内心最真实想法，
      仅仅把它表达出来就好，无论你如何选择，一切我都会坦然接受的
    </div>
  ...
  mounted() {
    var S = {
      init: function () {
        ...
        //想说的话
        S.UI.simulate(
          "XX|生日快乐|闭上眼|许个愿吧|我们|一起|铭记|这一刻|#countdown 3|#time"
        );
    ...
    let music =
      ...
      'src="https://music.163.com/outchain/player?type=2&id=1347110044&auto=1&height=66"></iframe>';
    this.$store.commit("setCloudMusic", music);

    setTimeout(() => {
      this.toGiftShow = true;
    }, 22000);
  },
};
</script>
